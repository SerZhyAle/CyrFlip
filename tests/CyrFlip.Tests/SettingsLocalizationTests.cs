...
namespace CyrFlip.Tests
{
    ...
    public class SettingsLocalizationTests
    {
        ...
        private static readonly string[] DynamicStrings =
        {
            ...
            "Ollama не найден — нажмите «Установить Ollama».", "Укажите имя модели, например qwen2.5:3b.",
            ...
            "Ollama не запущен.",
            "Не установлена ни одна модель. Рекомендуем qwen2.5:3b (~2 ГБ) — загрузите её в настройках.",
