...
namespace CyrFlip.Tests
{
    ...
    public class SettingsLocalizationTests
    {
        ...
        private static readonly string[] DynamicStrings =
        {
            ...
            "Логи для автора", "Архив с логами собран:", "Файл", "Размер", "Примечание",
            "обрезан — сохранён только конец файла", "не вошёл — превышен общий размер",
            "Письмо отправляете вы сами — CyrFlip ничего не передаёт в сеть. История буфера обмена в архив не включена. Внутри логов встречаются пути к файлам, а в них — имя вашей учётной записи Windows.",
