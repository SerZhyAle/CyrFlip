...
2. **Транслитерация одной клавишей.** Текст, набранный в неправильной раскладке, можно «перевернуть» на месте между QWERTY и JCUKEN (EN ↔ RU, UK в планах) горячей клавишей.
...
- **Транслитерация только EN ↔ RU.** Индикатор раскладки поддерживает EN/RU/UK, но «переворот» по горячей клавише пока преобразует между QWERTY и JCUKEN; украинские специфические буквы пока не транслитерируются.
- **При «перевороте» сохраняется только текст буфера обмена.** Изображения и файлы в буфере не восстанавливаются.
